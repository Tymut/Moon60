...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC, KC_RBRC, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
            KC_LGUI, TG(1), SH_TG, KC_SPC, KC_LEFT,       KC_RIGHT, KC_ENTER, KC_BSPC, TG(2), KC_RALT
),
...
[_LOWER_1] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
                XXXXXXX, TG(1), XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, TG(3), XXXXXXX
),
...
[_RAISE_2] = LAYOUT(
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, XXXXXXX,    XXXXXXX, KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
                XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, TG(2), XXXXXXX
),
/* ADJUST 3
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |QWERTY|      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_ADJUST_3] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, TG(3), XXXXXXX
  ),
/* COLEMAK 4
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  =   |
...
[_COLEMAK_4] = LAYOUT(
  ...
  KC_LCTL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC, KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                  KC_LGUI, TG(1), KC_LALT, KC_SPC, KC_LEFT,           KC_RIGHT, KC_ENTER, KC_BSPC, TG(2), KC_RALT
),
/* DVORAK 5
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  =   |
...
bool oled_task_user() {
    ...
    0x00, 0x80, 0xE0, 0xE0, 0xE0, 0xE0,
    0xE0, 0xE0, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x80, 0xC0, 0xE0, 0xF0, 0x70,
    ...
    0x07, 0x1F, 0x1F, 0x0F, 0x03, 0x00,
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0x00, 0x00, 0x07, 0x3F, 0x7F, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFE, 0xF8, 0xF0,
    0xE0, 0xE0, 0xE0, 0xC0, 0xC0, 0xC0,
    0xC0, 0xC0, 0xE0, 0xE0, 0xF0, 0x70,
    0x38, 0x0C, 0x00, 0x07, 0x3F, 0x7F,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0x7F, 0x3F, 0x0F, 0x00, 0x00, 0x00,
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0x00, 0x01, 0x07, 0x0F, 0x3F, 0xFF,
    ...
    0x0F, 0x0F, 0x0F, 0x07, 0x07, 0x03,
    0x03, 0x01, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x07, 0x07, 0x07,
    0x07, 0x07, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x01, 0x07, 0x07, 0x07,
