function plate_TRAYMOUNT_extrude_2_4_outline_fn(){
...
.subtract(
    CAG.circle({"center":[130.2500286,-12.0954226],"radius":1.7})
.union(
    ...
    new CSG.Path2D([[121.9497673,-27.9651103],[130.9616496,-38.7050534]]).appendPoint([141.7015927,-29.6931711]).appendPoint([132.6897104,-18.953228]).appendPoint([121.9497673,-27.9651103]).close().innerToCAG()
                ...
                function plateTRAY_case_fn() {
                    

                // creating part 0 of case plateTRAY
                let plateTRAY__part_0 = plate_TRAYMOUNT_extrude_2_4_outline_fn();

                // make sure that rotations are relative
                let plateTRAY__part_0_bounds = plateTRAY__part_0.getBounds();
                let plateTRAY__part_0_x = plateTRAY__part_0_bounds[0].x + (plateTRAY__part_0_bounds[1].x - plateTRAY__part_0_bounds[0].x) / 2
                let plateTRAY__part_0_y = plateTRAY__part_0_bounds[0].y + (plateTRAY__part_0_bounds[1].y - plateTRAY__part_0_bounds[0].y) / 2
                plateTRAY__part_0 = translate([-plateTRAY__part_0_x, -plateTRAY__part_0_y, 0], plateTRAY__part_0);
                plateTRAY__part_0 = rotate([0,0,0], plateTRAY__part_0);
                plateTRAY__part_0 = translate([plateTRAY__part_0_x, plateTRAY__part_0_y, 0], plateTRAY__part_0);

                plateTRAY__part_0 = translate([0,0,0], plateTRAY__part_0);
                let result = plateTRAY__part_0;
